...
#
# plt.tight_layout()
# plt.savefig("../../../assets/plots/tests_index+vol/kcp_index+vol_subplots_all_breaks.png")
# plt.show()
...
plt.tight_layout()
plt.savefig("../../../assets/plots/tests_index+vol/kcp_index+vol_subplots_stable.png")
plt.show()

# 7. SAVE RESULTS
stability_df.to_csv("../../../data/tests/index+vol/kcp_index+vol_breakpoints_stability.csv", index=False)

stable_points.to_csv("../../../data/tests/index+vol/kcp_index+vol_stable_breakpoints.csv", index=False)
