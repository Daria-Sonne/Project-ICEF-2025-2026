...
# 1. LOAD MATCHES
df = pd.read_csv("../../../data/tests/index+vol/index+vol_breakpoint_matches.csv", parse_dates=["kcp_date"])
...
final_df.to_csv("../../../data/tests/index+vol/index+vol_final_breakpoints.csv", index=False)