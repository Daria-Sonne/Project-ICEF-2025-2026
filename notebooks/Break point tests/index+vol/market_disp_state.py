...
market_disp_state = pd.DataFrame({"market_return": market_return,"dispersion": dispersion}).dropna()

# SCALE
scaler = StandardScaler()
market_disp_scaled = pd.DataFrame(scaler.fit_transform(market_disp_state),index=market_disp_state.index,columns=market_disp_state.columns)
