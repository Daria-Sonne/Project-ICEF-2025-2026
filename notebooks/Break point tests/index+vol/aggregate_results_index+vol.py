...
# 2. LOAD BREAKPOINTS
kcp_path = "../../../data/tests/index+vol/kcp_index+vol_stable_breakpoints.csv"
pelt_path = "../../../data/tests/index+vol/pelt_index+vol_stable_breakpoints.csv"
...
# 5. SAVE RESULTS
matches_df.to_csv("../../../data/tests/index+vol/index+vol_breakpoint_matches.csv", index=False)
...
axes[0].set_title("KCP index+vol_Breakpoints (Aggregate)")
axes[0].legend()
...
axes[1].set_title("PELT index+vol_Breakpoints (Aggregate)")
axes[1].legend()
axes[1].grid(alpha=0.3)

plt.tight_layout()
plt.savefig("../../../assets/plots/tests_index+vol/index+vol_kcp_vs_pelt_aggregate_subplots.png")
plt.show()
