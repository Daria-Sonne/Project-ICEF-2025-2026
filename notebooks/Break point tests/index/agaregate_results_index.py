...
# 1. LOAD DATA
data_path = "../../../data/preprocessed/market_state_scaled.csv"
...
# 2. LOAD BREAKPOINTS
kcp_path = "../../../data/tests/index/kcp_index_stable_breakpoints.csv"
pelt_path = "../../../data/tests/index/pelt_index_stable_breakpoints.csv"
...
# 5. SAVE RESULTS
matches_df.to_csv("../../../data/tests/index/index_breakpoint_matches.csv", index=False)
...
axes[0].set_title("KCP index_Breakpoints (Aggregate)")
axes[0].legend()
...
axes[1].set_title("PELT index_Breakpoints (Aggregate)")
axes[1].legend()
axes[1].grid(alpha=0.3)

plt.tight_layout()
plt.savefig("../../../assets/plots/tests_index/index_kcp_vs_pelt_aggregate_subplots.png")
plt.show()
...
# plt.grid(alpha=0.3)
#
# plt.savefig("../../../assets/plots/tests_index/index_kcp_vs_pelt_overlay.png")
# plt.show()