...
plt.tight_layout()
plt.grid(alpha=0.3)
plt.savefig("../../../assets/plots/tests_index/pelt_index_subplots_all_breaks.png")
plt.show()
...
plt.tight_layout()
plt.grid(alpha=0.3)
plt.savefig("../../../assets/plots/tests_index/pelt_index_subplots_stable.png")
plt.show()

# 7. SAVE RESULTS
stability_df.to_csv("../../../data/tests/index/pelt_index_breakpoints_stability.csv", index=False)
stable_points.to_csv("../../../data/tests/index/pelt_index_stable_breakpoints.csv", index=False)
