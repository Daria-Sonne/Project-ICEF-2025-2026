...
# 1. LOAD MATCHES
df = pd.read_csv("../../../data/tests/index+vol+corr/index+vol+corr_breakpoint_matches.csv", parse_dates=["kcp_date"])
...
final_df.to_csv("../../../data/tests/index+vol+corr/index+vol+corr_final_breakpoints.csv", index=False)